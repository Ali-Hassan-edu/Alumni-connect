        ...
        <div className="bg-card border border-border rounded-2xl p-4 sm:p-6 lg:p-8">
          {sent ? (
            <div className="text-center">
              ...
              <p className="text-muted-foreground text-xs sm:text-sm mb-6">We sent a reset link to <strong>{getValues('email')}</strong></p>
              <Link to="/auth/login" className="flex items-center justify-center gap-2 text-xs sm:text-sm text-blue-600 hover:text-blue-700 font-medium">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input {...register('email')} type="email" placeholder="your@email.com" className="w-full pl-10 sm:pl-11 pr-4 py-2.5 sm:py-3 min-h-12 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm transition-all" />
                  </div>
